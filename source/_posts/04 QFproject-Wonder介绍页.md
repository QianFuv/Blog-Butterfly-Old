...
* [Friends & Foes - 被淘汰的更新](https://www.mcmod.cn/class/6232.html)
  加入了一些Minecraft官方淘汰的更新内容，包括但不限于“同伴”（怒目怪、哞花和铜傀儡等）、“敌人”（冰术师、幻术师、海藤壶、大胃怪和野火等）、“方块”（蜂箱、金凤花和铜按钮等）和“结构”（养蜂场、铜傀儡工坊、冰术师小屋、幻术师小屋和下界城堡等）等
*
...
* [Traverse - 遍历](https://www.mcmod.cn/class/1416.html)
  新增了近30种新的生物群系，一些新的装饰方块等
  {% hideToggle MC百科下一些有趣的评论 %}
  ![](https://vip2.loli.io/2023/06/05/xijZAl2F8HNCuoJ.png)
  {% endhideToggle %}
* [Mo Glass - 玻璃楼梯/台阶](https://www.mcmod.cn/class/7214.html)
  添加了各种颜色的玻璃楼梯与玻璃台阶
...
* [Better Compatibility Checker - 更好的版本检查](https://www.mcmod.cn/class/5542.html)
  当你无法加入服务器时，会返回至服务器列表，此时就会在服务器最右侧看到服务器版本检查图标，如果为红色的“ x ”号，说明客户端版本和服务器版本不符，请检查自动更新是否正常运作/是否私自增删了模组/配置文件，如果都检查无误或者图标为绿色的“ √ ”，请联系腐竹检查/重新下载客户端
*
...
* [Iceberg - 冰山](https://www.mcmod.cn/class/5074.html)
  为超出屏幕的提示文本提供换行（实测还是有一些模组的提示文本无法换行，兼容性不佳），同时也是其他模组的前置，作为库模组加载
*

...
首先，服务端核心分为四大类：**模组端**（forge/fabric/quilt/...）、**插件端**（spigot/paper/purpur/...）、**原版端**（minecraft）、**混合端**（catserver/arclight/...）
...
> 老牌插件端核心，兼容spigot/bukkit插件，目前性能不够看
...
![](https://vip2.loli.io/2023/03/22/PXOA2mfeRo7xu3p.png)

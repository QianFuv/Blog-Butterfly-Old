...
**详情链接**
[MC百科](https://www.mcmod.cn/class/9211.html) • [Curseforge](https://www.curseforge.com/minecraft/mc-mods/amethyst-core) • [Modrinth](https://modrinth.com/mod/amethyst-core) • [Github](https://github.com/fzzyhmstrs/ac)
...
**详情链接**
[MC百科](https://www.mcmod.cn/class/3434.html) • [Curseforge](https://www.curseforge.com/minecraft/mc-mods/architectury-api) • [Modrinth](https://modrinth.com/mod/architectury-api) • [Github](https://github.com/architectury/architectury-api)

### Better Runtime Resource Pack 更好的运行时资源包

**内容介绍**
BRRP（Better Runtime Resource Pack，更好的运行时资源包），是可用于在运行时创建游戏资源的前置模组，是基于 ARRP 模组的一个分支；运行时资源包是在运行时创建的 Minecraft 资源文件，从而避免一些重复的操作；对于存在大量相似方块和物品的模组而言，借助运行时资源包可以极大地减小模组文件的大小。
**详情链接**
[MC百科](https://www.mcmod.cn/class/6297.html) • [Curseforge](https://www.curseforge.com/minecraft/mc-mods/better-runtime-resource-pack) • [Modrinth](https://modrinth.com/mod/brrp) • [Github](https://github.com/SolidBlock-cn/BRRP)

### Bad Packets

**内容介绍**
Bad Packets 是一款允许在不同的模组平台之间进行数据包消息传递的库；意思是说，对于那些支持 Bad Packets 的模组而言，其 Fabric 的客户端版本可以向 Forge 版的服务器通信，反之亦然。
**详情链接**
[MC百科](https://www.mcmod.cn/class/6275.html) • [Curseforge](https://www.curseforge.com/minecraft/mc-mods/badpackets) • [Modrinth](https://modrinth.com/mod/badpackets) • [Github](https://github.com/badasintended/badpackets)

### Balm

**内容介绍**
作者本人的跨平台前置 Lib，该Lib便于作者跨 Fabric 与 Forge 平台编写 1.17+ 版本的 Mod。
**详情链接**
[MC百科](https://www.mcmod.cn/class/4485.html) • [Curseforge](https://www.curseforge.com/minecraft/mc-mods/balm-fabric) • [Modrinth](https://modrinth.com/mod/balm) • [Github](https://github.com/TwelveIterationMods/Balm)

### BCLib

**内容介绍**
这是更好的末地（从0.9.7版本起）、更好的下界（1.18及以上）、伊甸之环和 BetterX 团队未来的模组的模组库；当然其他开发者也可以用该库来制作自己的模组。
**详情链接**
[MC百科](https://www.mcmod.cn/class/4183.html) • [Curseforge](https://www.curseforge.com/minecraft/mc-mods/bclib) • [Modrinth](https://modrinth.com/mod/bclib) • [Github](https://github.com/paulevsGitch/BCLib)
...
1. 服务器有专属配套客户端，一次下载自动更新永久使用。
2. 请查看服务器官方Q群置顶公告，附有客户端下载链接。

## 2. 如何申请服务器白名单？

请查看QQ群内置顶公告或者点击[这里](https://docs.qq.com/form/page/DQmlyY05GeEdSQXpt)进入填写白名单审核问卷，填写完成后如果过审将在群内@。
